...
| Project | What it does |
| --- | --- |
| [Stacksheet](https://github.com/howells/stacksheet) | A React sheet-stack system with Motion animations, focus handling, safe navigation, and mobile-aware behavior. |
